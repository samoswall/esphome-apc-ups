...
| Switch | K |  | Shutdown with grace period @TODO
...
| Switch | Z |  | Shutdown immediately @TODO
...
| Text_Sensor (writable) | x | last_battery_change_date | Last battery change date @TODO (write date)
